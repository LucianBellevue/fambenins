 ...
 function ContactPageInner() {
   ...
   // Everflow (and similar networks) usually pass `transaction_id` in the URL.
   const externalTransactionId = searchParams.get('transaction_id');
     ...
     <div className="min-h-screen bg-gray-50" suppressHydrationWarning>
       ...
       <section className="py-16">
         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
           <ContactForm transactionId={externalTransactionId} />
